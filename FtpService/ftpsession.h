...
enum transfer_mode_e {
  PASV_MODE_ENABLE = 1, PORT_MODE_ENABLE = 2,
};

enum transfer_cmdtype_e {

  TRANSFER_PASV_STANDBY_REQ = 1, TRANSFER_PASV_STANDBY_RES,

  TRANSFER_PORT_STANDBY_REQ, TRANSFER_PORT_STANDBY_RES,

  TRANSFER_TRY_CONNNECT_REQ, TRANSFER_TRY_CONNNECT_RES,

  TRANSFER_SENDCOMMAND_REQ, TRANSFER_SENDCOMMAND_RES,

  TRANSFER_FILEUPLOAD_REQ, TRANSFER_FILEUPLOAD_RES,

  TRANSFER_FILEDOWNLOAD_REQ, TRANSFER_FILEDOWNLOAD_RES,

  TRANSFER_ABORT_REQ, TRANSFER_ABORT_RES,
};
