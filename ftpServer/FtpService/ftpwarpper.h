...
public:
    ...
    int PASV_FtpTransferStandby(FtpSession &session, FtpInstruction &__instruction);

    int PORT_FtpTransferStandby(FtpSession &session, FtpInstruction &__instruction);

    int WORK_FtpTryContact(FtpSession &session, FtpInstruction &__instruction);

    int WORK_FtpTrySendCommand(FtpSession &session, FtpInstruction &__instruction);

    int WORK_FtpTryFileDownload(FtpSession &session, FtpInstruction &__instruction);
...
public:
    ...
    int getInsContentLength() {return InsLength;}

    void setInsContentLength(int __insLength) {InsLength = __insLength;}


    int getInsType() {return InsType;}

    void setInsType(int __insType) {InsType = __insType;}


    bool IsInsExecSuccess() {return InsExecOK;}

    void setInsExecFlag(bool __insExecOK) {InsExecOK = __insExecOK;}


    char* getInsContent() {return InsContent;}
