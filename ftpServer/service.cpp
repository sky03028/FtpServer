...
int Service::ServiceInit()
{
    ...
    Threads->ThreadsCreate(Service::ServiceThreadHandler , (void *)this, mMaxThreadCount);
...
int Service::ServiceStart()
{
    ...
    do{
        ...
        s = SocketSource::TcpAccept(mServerSocket, (struct sockaddr *)&client, mAcceptTimeout);
        if(s >= 0)
        {
